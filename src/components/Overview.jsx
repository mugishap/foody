    ...
    <div className="overall">
      ...
      <div className="overview-body">
       <div className="navBar">
        ...
        <img className="overview-img" src="https://images.unsplash.com/photo-1556014633-e65544133b86?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8c3RhbmRpbmclMjBhbG9uZXxlbnwwfHwwfHw%3D&w=1000&q=80" alt=""></img>
        ...
        <div className="Client">
          ...
          <div className="All">
              <h4 className="overview-h4">All Clients</h4>
              <div className="head">
